<template>
  <main>
    <div style="margin-bottom:20px;" class="header">
      <a href="#" class="active" @click="setMax(10, 1, 10, 2, $event)">10以内</a> &nbsp; &nbsp; <a href="#" @click="setMax(20, 10, 10, 2, $event)">20以内（第二个数10以内）</a> &nbsp; &nbsp; <a href="#" @click="setMax(20, 10, 20, 2, $event)">20以内</a> &nbsp; &nbsp; <a href="#" @click="setMax(20, 1, 20, 3, $event)">20以内（3个数）</a> &nbsp; &nbsp;
